...
# 创建按钮
Button(root, text="Log In", font=BUTTON_FONT, bg='#007BFF',width = 10 , fg='white', command=lambda: print("Log In")).grid(
    row=2, column=0, columnspan=2, pady=10, ipadx=20, ipady=5
)
Button(root, text="Sign Up", font=BUTTON_FONT, bg='#28A745',width = 10 , fg='white', command=lambda: print("Sign Up")).grid(
    row=3, column=0, columnspan=2, pady=10, ipadx=20, ipady=5
)
